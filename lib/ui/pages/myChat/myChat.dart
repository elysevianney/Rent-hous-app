                ...
                children: [
                  Column(
                    children: [
                      ...
                      const SizedBox(height: 12,),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Anaelle', lastMessage: 'Cc je suis interrssé', userID: '2',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Eliot', lastMessage: 'Cc je suis interrssé', userID: '3',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Kate', lastMessage: 'Cc je suis interrssé', userID: '4',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Hanane', lastMessage: 'Cc je suis interrssé', userID: '5',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Junior', lastMessage: 'Cc je suis interrssé', userID: '6',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Audrey', lastMessage: 'Cc je suis interrssé', userID: '7',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Marc', lastMessage: 'Cc je suis interrssé', userID: '8',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Papa', lastMessage: 'Cc je suis interrssé', userID: '9',),
                      MessageView(userProfil: $AppAssets.imgs.profil, senderUsername: 'Maman', lastMessage: 'Cc je suis interrssé', userID: '10',)
                    ],
                  ),
                ],
              ),
