...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    TextStyle incomingChatLinkTitleStyle = const TextStyle(color: Colors.black, fontFamily:  'Poppins'),
    TextStyle outgoingChatLinkTitleStyle = const TextStyle(color: Colors.white, fontFamily:  'Poppins'),
    TextStyle outgoingChatLinkBodyStyle = const TextStyle(color: Colors.white, fontFamily:  'Poppins'),
    TextStyle incomingChatLinkBodyStyle = const TextStyle(color: Colors.white, fontFamily:  'Poppins'),
    double elevation = 1,
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(fontFamily:  'Poppins'),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle( fontFamily:  'Poppins'),
...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = AppColors.primaryTwo,
    Color flashingCircleBrightColor = const Color(0xffFCD8DC),
    TextStyle incomingChatLinkTitleStyle = const TextStyle(color: Colors.black, fontFamily:  'Poppins'),
    TextStyle outgoingChatLinkTitleStyle = const TextStyle(color: Colors.black, fontFamily:  'Poppins'),
    TextStyle outgoingChatLinkBodyStyle = const TextStyle(color: Colors.grey, fontFamily:  'Poppins'),
    TextStyle incomingChatLinkBodyStyle = const TextStyle(color: Colors.grey, fontFamily:  'Poppins'),
    ...
    Color backArrowColor = AppColors.black2,
    Color backgroundColor = const Color(0xffeeeeee),
    Color replyDialogColor = AppColors.orangeHint,
    Color linkPreviewOutgoingChatColor = const Color(0xffFCD8DC),
    Color linkPreviewIncomingChatColor = const Color(0xFFEEEEEE),
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle( fontFamily:  'Poppins'),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle( fontFamily:  'Poppins'),
    Color replyTitleColor = AppColors.primaryTwo,
    ...
    Color verticalBarColor = AppColors.primaryTwo,
